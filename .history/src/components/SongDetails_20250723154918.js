...
export const  AboutInfoList = [
  {
    character: "Love",
    aboutTrait: "Magdalene's love is unconditional and transformative, inspiring those around her to embrace their true selves. Love is embedded in heart like a song, resonating with every beat of her being.",
    photo: Img7,
    icon: "❤️",
    sentiment: "Love is the melody that binds us all, a song that echoes through the heart of every soul.",
  },
  {
    character: "Courage",
    aboutTrait: "Magdalene's courage is unwavering, empowering her to face challenges head-on and inspire others to do the same. Her bravery shines like a beacon of hope in the darkest times.",
    photo: Img10,
    icon: "🦁",
    sentiment: "Courage is not the absence of fear, but the triumph over it, a song that resonates with the strength of the human spirit.",
  },
  {
    character: "Beauty",
    aboutTrait: "Magdalene's beauty is not just skin deep; it radiates from her soul, captivating all who encounter her. Her presence is a work of art, a testament to the beauty of the human spirit.",
    photo: Img41,
    icon: "🌹",
    sentiment: "Beauty is the song of the soul, a melody that transcends time and space, touching the hearts of all who hear it.",
  },
  {
    character: "Empathy",
    aboutTrait: "Magdalene's empathy allows her to connect deeply with others, understanding their struggles and joys. Her compassion is a guiding light, fostering unity and healing.",
    photo: Img5,
    icon: "🤝",
    sentiment: "Empathy is the bridge that connects us all, a song that harmonizes our hearts in understanding and kindness.",
  },
  {
    character: "Wisdom",
    aboutTrait: "Magdalene's wisdom is profound, guiding her decisions and actions with clarity and insight. Her knowledge is a treasure trove, illuminating the path for others.",
    photo: Img50,
    icon: "🦉",
    sentiment: "Wisdom is the compass that guides us through the storms of life, a song that resonates with the depth of our experiences.",
  },
  {
    character: "Joy",
    aboutTrait: "Magdalene's joy is infectious, spreading happiness and positivity wherever she goes. Her laughter is a melody that uplifts spirits and brings people together.",
    photo: Img42,
    icon: "🎉",
    sentiment: "Joy is the song of the soul, a celebration of life that dances through our hearts and unites us in happiness.",
  },
  {
    character: "Resilience",
    aboutTrait: "Magdalene's resilience is unyielding, allowing her to overcome adversity with grace and strength. Her determination is a testament to the power of the human spirit.",
    photo: Img24,
    icon: "🌱",
    sentiment: "Resilience is the anthem of survival, a song that echoes through the trials of life, reminding us of our strength.",
  },
  {
    character: "Creativity",
    aboutTrait: "Magdalene's creativity knows no bounds, inspiring innovation and artistic expression. Her imagination is a canvas, painting the world with vibrant colors and ideas.",
    photo: Img45,
    icon: "🎨",
    sentiment: "Creativity is the song of the soul, a melody that dances through our minds, inspiring us to create and innovate.",
  },
  {
    character: "Kindness",
    aboutTrait: "Magdalene's kindness is a gentle force, spreading warmth and compassion to all. Her acts of kindness are like ripples in a pond, creating waves of positivity.",
    photo: Img15,
    icon: "🌸",
    sentiment: "Kindness is the song that resonates in every heart, a melody that brings us closer together in love and understanding.",
  },
  {
    character: "Talented(football)",
    aboutTrait: "Magdalene's talent on the football field is unmatched, showcasing her skill and passion for the game. Her dedication and hard work inspire others to pursue their dreams. She scores dreams, not just goals. She is a champion in many peoples hearts.She is a great defender number 5.She defends lost hopes and dreams. She is a great footballer.",
    photo: Img8,
    icon: "⚽",
    sentiment: "Talent is the spark that ignites our passions, a song that drives us to excel and achieve greatness.",
  },
  {
    character: "Talented(singing)",
    aboutTrait: "Magdalene's singing voice is a gift, enchanting listeners with its beauty and emotion. Her music is a source of inspiration and joy, touching the hearts of many.",
    photo: Img39,
    icon: "🎤",
    sentiment: "Singing is the song of the soul, a melody that transcends words and speaks directly to the heart.",
  },
  {
  character: "Magdalene",
  aboutTrait: "Magdalene is a starlit dream walking through a field of forgotten songs. From the fabrics of life, she weaves tenderness and meaning, stitching time with threads of memory and wonder. She is the chef-d'œuvre of love’s imagination — a living masterpiece sculpted by grace. She weaves love into the wind, and her heart speaks in the dialect of constellations. Wherever she wanders, the sky bends gently to listen, and roses bloom even in the dark.",
  photo: Img3,
  icon: "🌌",
