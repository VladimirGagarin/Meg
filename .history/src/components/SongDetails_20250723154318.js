...
export const  AboutInfoList = [
  ...
  {
    character: "Magdalene",
    aboutTrait: "Magdalene is a symbol of hope, love, and resilience. Her journey inspires others to embrace their true selves and live authentically. She is a beacon of light in a world that often feels dark.",
    photo: Img3,
    icon: "🌟",
    sentiment: "Magdalene's light shines brightly, illuminating the path for others and reminding us of the beauty within ourselves." 
