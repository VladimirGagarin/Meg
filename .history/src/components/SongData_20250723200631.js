...
export function MagdaleneQuotes() {
  const quotes = [
    {
      text: "Love is the silent hum between stars—a vibration too deep for ears, yet felt by every cell that remembers it was once stardust.",
      start: 0,
      end: 14500,
    },
    {
      text: "Your heartbeat composes symphonies no orchestra could play—each pulse a percussion of primordial poetry written before time had language.",
      start: 16000,
      end: 32000,
    },
    {
      text: "To create art is to let your soul bleed in colors the world forgot to name—each brushstroke a fossil of feelings that outlive bones.",
      start: 35000,
      end: 52000,
    },
    {
      text: "Talent is just obsession refined by time—an alchemy where your wounds become the crucible for gold you didn’t know you carried.",
      start: 55000,
      end: 72000,
    },
    {
      text: "Listen closely—the universe tunes your nerves like violin strings. Your trembling isn’t fear, but resonance with some infinite song.",
      start: 75000,
      end: 92000,
    },
    {
      text: "Self-worth isn’t earned like wages—it’s recognized like dawn. You don’t build it, you remember it through the cracks of every broken mirror.",
      start: 95000,
      end: 112000,
    },
    {
      text: "Skills are just ghosts of your future self reaching backward through time—whispering muscle memories you haven’t lived yet.",
      start: 115000,
      end: 130000,
    },
    {
      text: "Life doesn’t happen to you—it happens through you. You’re not a passenger, but the landscape itself dreaming of motion.",
      start: 133000,
      end: 148000,
    },
    {
      text: "The most surreal art is your unmasked laughter—a sound so foreign to the cosmos that galaxies pause their expansion to listen.",
      start: 151000,
      end: 168000,
    },
    {
      text: "You aren’t falling in love—you’re recognizing fragments of your own soul that escaped during the Big Bang and took form in another.",
      start: 171000,
      end: 190000,
    },
    {
      text: "Music is time’s skeleton key—three notes can collapse decades, make old ghosts sit at your table, turn scars into compasses.",
      start: 193000,
      end: 210000,
    },
  ];
