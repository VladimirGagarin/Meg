...
export  function ThenLyrics(){
  const lyrics = [
    ...
    { 'start': 48000, 'end': 57000, 'text': 'Now and always  through all hours—, then and only then forever ours, my little end.' },
    ...
    { 'start': 134000, 'end': 140000, 'text': 'Then and only then forever ours, my little end.' },
    { 'start': 152000, 'end': 154000, 'text': 'My little end.' }
  ];
  return lyrics
}
