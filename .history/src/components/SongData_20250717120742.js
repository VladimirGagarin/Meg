...
export  function ThenLyrics(){
  const lyrics = [
    ...
    { 'start': 123000, 'end': 130000, 'text': 'Then and only then, forever ours, like we stored what was for us ours,' },
    { 'start': 130000, 'end': 134000, 'text': 'past and present now, down.' }, { 'start': 134000, 'end': 140000, 'text': 'Then and only then forever ours, my little end.' }, { 'start': 152000, 'end': 154000, 'text': 'My little end.' }]
    ;
    return lyrics
}
