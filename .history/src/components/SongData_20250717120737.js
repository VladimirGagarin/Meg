...
export  function ThenLyrics(){
  const lyrics = [
    ...
    { 'start': 78000, 'end': 85000, 'text': "Then and only then, forever ours, time bowed down to love's own powers." },
    { 'start': 85000, 'end': 94000, 'text': 'Now and always through our house, then and only then forever ours, my little end.' },
    { 'start': 108000, 'end': 115000, 'text': 'Seasons turned but we remained bound by joy through loss and gain.' }, 
    { 'start': 115000, 'end': 123000, 'text': 'Then and only then our story flows where love begins and always grows.' }, { 'start': 123000, 'end': 130000, 'text': 'Then and only then, forever ours, like we stored what was for us ours,' }, { 'start': 130000, 'end': 134000, 'text': 'past and present now, down.' }, { 'start': 134000, 'end': 140000, 'text': 'Then and only then forever ours, my little end.' }, { 'start': 152000, 'end': 154000, 'text': 'My little end.' }]
    ;
    return lyrics
}
