...
export const AboutInfoList = [
  ...
  {
    character: "Gift",
    aboutTrait: "Magdalene  is a velvet of a devoted gift, a treasure that enriches the lives of those around her. Her presence is a blessing, a reminder of the beauty and magic in the world.A cradled gift f",
  }
  {
