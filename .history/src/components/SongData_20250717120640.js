...
export function RosesOfRomeLyrics() {
  ...
  { start: 28000, end: 36000, text: "Plenty will flourish deep in your heart Magdalene Bear" },
...
export  function ThenLyrics(){
  const lyrics = [
    ...
    { 'start': 0, 'end': 15000, 'text': 'When shadows fall beneath the starlit skies, we found our path where still this lies.' },
    { 'start': 15000, 'end': 23000, 'text': 'Then and only then the truth was clear, love was always waiting here.' }, { 'start': 23000, 'end': 32000, 'text': 'In quiet dreams we walked as one, beneath the moon, beneath the sun.' }, { 'start': 32000, 'end': 40000, 'text': 'Then and only then the world stood still, hearts aligned by sacred will.' }, { 'start': 40000, 'end': 48000, 'text': "Then and only then, forever ours, time bowed down to love's own powers." }, { 'start': 48000, 'end': 57000, 'text': 'Now and always through our house, then and only then forever ours, my little end.' }, { 'start': 63000, 'end': 70000, 'text': 'Seasons turned but we remained bound by joy through loss and gain.' }, { 'start': 70000, 'end': 78000, 'text': 'Then and only then our story flows where love begins and always grows.' }, { 'start': 78000, 'end': 85000, 'text': "Then and only then, forever ours, time bowed down to love's own powers." }, { 'start': 85000, 'end': 94000, 'text': 'Now and always through our house, then and only then forever ours, my little end.' }, { 'start': 108000, 'end': 115000, 'text': 'Seasons turned but we remained bound by joy through loss and gain.' }, { 'start': 115000, 'end': 123000, 'text': 'Then and only then our story flows where love begins and always grows.' }, { 'start': 123000, 'end': 130000, 'text': 'Then and only then, forever ours, like we stored what was for us ours,' }, { 'start': 130000, 'end': 134000, 'text': 'past and present now, down.' }, { 'start': 134000, 'end': 140000, 'text': 'Then and only then forever ours, my little end.' }, { 'start': 152000, 'end': 154000, 'text': 'My little end.' }]
    ;
    return lyrics
}
  ...
  const subtitles = [
    {
      ...
      text: "In the silken dusk her shadow fell In depths of night her silence dwells",
    },
    {
      start: 16000,
      end: 24000,
    ...
    },
    {
      ...
      text: "The stars gaze still in solemn press Behold the mighty impress",
    },
    {
      start: 30000,
      end: 38000,
      text: "Empress the dawn in every pose The flame where silent wonder blows adorable",
    },
    {
      start: 38000,
      end: 45000,
    ...
    },
    {
      ...
      text: "Magdalene in the impress we all want Magdalene the soul we've sought so long",
    },
    {
      start: 54000,
      end: 61000,
    ...
    },
    {
      ...
      text: "It petals soft her mercy glows In thunder's hush her wisdom flows",
    },
    {
      start: 68000,
      end: 75000,
    ...
    },
    {
      ...
      text: "The sea confess beneath the tide She walks with stars and holds the fight",
    },
    {
      start: 146000,
      end: 153000,
      text: "The storm once cold now holds her heat The dust remembers every beat",
    },
    {
      start: 153000,
      end: 161000,
      text: "And time itself once wild and free Still to watch her silent wave",
    },
    ...
    },
    {
      ...
      text: "Magdalene the impress we all want Magdalene the soul we've sought so long",
    },
    {
      start: 190000,
      end: 197000,
    ...
    },
    {
      ...
      text: "Magdalene and stars she's drawn The impress of our raking dawn",
    },
  ];
return subtitles
}