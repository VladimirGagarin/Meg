  ...
  return (
    <div style={{ padding: "2rem", textAlign: "center" }}>
      ...
      >
        ...
        <p style={{ fontStyle: "italic", lineHeight: 1.6, color: "#444" }}>
          Beneath the hush of twilight’s veil,
          <br />
          I breathe your name, so soft, so pale.
          <br />
          A psalm not sung in worldly air,
          <br />
          But held within — my whispered prayer.
          <br />
          <br />
          Through quiet stars your echoes flow,
          <br />
          In every sigh the lilies know.
          <br />
          Magdalene, the rose I wear,
          <br />
          My solace found in whispered prayer.
          <br />
          <br />
          Though data sleeps and screens may fade,
          <br />
          Your voice remains — a serenade.
          <br />
          Offline, yet near, you're always there —<br />
          My Magdalene, my whispered prayer.
        </p>
      </div>
    </div>
  );
