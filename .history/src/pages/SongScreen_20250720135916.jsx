        ...
        <div className="Sonnet-overlay">
          <div className="Sonnet-content">
            <div className="Controls">
              <audio src={SonnetSong} ref={sonnetAudioRef} loop></audio>
              <button onClick={PlaySonnet}>{isPlayingSonnet ? <FaPause/> : <FaPlay/> }</button>
              <button onClick={closeSonnetModal}><FaTimes/> Stop</button>
            </div>
            <div className="lyrics-sonnet">{ currentSonnetLyrics}</div>
              </div>
        </div>
      )}
    </div>
