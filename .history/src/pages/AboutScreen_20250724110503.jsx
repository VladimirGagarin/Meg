...
export default function AboutScreen() {
  ...
  return (
    <div className="about-screen">
      ...
      <p>This website Sing With Magdalene (SWM) is dedicated to the music and vision of Magdalene.</p>
      <p>It is a place where you can listen to her songs, read the lyrics, and learn more about her vision.</p>
      <p>Magdalene is a visionary artist who creates music that inspires and uplifts.</p>
      <p> Magdalene resonates with the themes of love, healing, and transformation.</p>
      ...
      <Outlet />
      <footer>
        <p>Made with ❤️.We believe. She becomes We love. She flutters. We rise. She inspires.</p>
