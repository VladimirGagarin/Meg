...
import { FaPlay, FaPause, FaRedoAlt, FaTimes, FaSyncAlt, FaRetweet } from "react-icons/fa";
          ...
          return (
            ...
            >
              ...
              <div className="song-controls">
                ...
                >
                  {isLooping ? (
                    <FaSyncAlt className="spin" /> // Animated when active
                  ) : (
                    <FaRetweet /> // Static when inactive
                  )}
                </button>
              </div>
