      ...
      {showSonnetModal && (
        <div className="modal-backdrop">
          <div className="modal-content">
            <h2>🌹 Roses of Rome</h2>
            <p>
              Would you like to hear a final sonnet — a quiet echo through the
              veil?
            </p>

            <div className="modal-buttons">
              <button onClick={handleSonnetsong}>Yes Please!</button>
              <button onClick={closeSonnetModal}>No Thanks!</button>
            </div>
          </div>
        </div>
      )}
